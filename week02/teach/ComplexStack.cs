public static class ComplexStack {
    ...
    public static void Main() {
        ...
        Console.WriteLine("(a == 3 or (b == 5 and c == 6)) = ");
        ...
        //                          here -------\/
        Console.WriteLine("(students]i].Grade > 80 and students[i].Grade < 90   =  " ); 
        ...
        //                 here -------\/
        Console.WriteLine( "(robot[id + 1].Execute(.Pass() || (!robot[id * (2 + i)].Alive && stormy) || (robot[id - 1].Alive && lavaFlowing))  = " );
